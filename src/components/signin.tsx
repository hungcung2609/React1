      ...
      <section className="grid h-screen items-center lg:grid-cols-2">
        <div className="my-auto p-8 text-center sm:p-10 md:p-20 xl:px-32 xl:py-24">
          ...
          <form action="#" className="mx-auto max-w-[24rem] text-left">
            <div className="mb-4">
              <Input color="gray" size="lg" label="Email" type="email" name="email" crossOrigin="anonymous"/>
            </div>
            <div className="mb-4">
              <Input color="gray" size="lg" label="Password" type="password" name="password" crossOrigin="anonymous"/>
            </div>
